...
export default function HotkeyRow({ label, shortcut, onClick }: HotkeyRowProps) {
  return (
    <button
      type="button"
      onClick={onClick}
      className="flex w-full items-center justify-between rounded-md border border-input bg-background px-3 py-2 text-left transition-colors hover:bg-accent focus:outline-none focus-visible:border-ring"
    >
